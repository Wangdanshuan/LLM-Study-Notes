...
if __name__ == '__main__':
    ...
    model_directory = "/home/bingxing2/home/scx6mdq/myllm/ChatGLM3-main-0209/finetune_demo/chatglm3-6b-climate-output/checkpoint-2000"  # 这里替换成你的模型目录路径
    model, tokenizer = load_model(model_directory)
    mydf = pd.read_excel('/home/bingxing2/home/scx6mdq/DMA_unlabel_datasets.xlsx')
